...
def levenshtein_ratio_and_distance(s, t, ratio_calc=False):
    ...
    if ratio_calc:
        ...
        # print(distance) # Uncomment if you want to see the matrix showing how the algorithm computes the cost of
        # deletions, insertions and/or substitutions This is the minimum number of edits needed to convert string a
        # to string b
